    ...
    <div id="about-me" className="flex justify-center items-center w-full shadow-lg h-full bg-gray-200 dark:bg-gray-900">
      <div className="w-full h-full mt-33 bg-gray-200 dark:bg-gray-900 pb-20">
        <div className="max-w-7xl w-full m-auto">
          ...
          <p className="text-center w-3/4 m-auto font-normal text-lg text-gray-800 dark:text-gray-200 mb-16">Hard skills, soft skills e tecnologias que tenho conhecimento.</p>
          <div className="flex gap-20 w-full media-about-me p-4">
            <div className="w-full flex flex-col items-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-5 w-4/5">
                ...
                Atualmente, estou cursando o quarto semestre de Engenharia da Computação na USF Itatiba e
                tenho me dedicado aos estudos de front-end usando React typescript, e atualmente estudando node. Procuro vaga junior/estágio para desenvolvedor front-end usando React ou backend usando node. Estou sempre aberto a aprender diferentes tecnologia que não conheço para receber oportunidade de trabalho. E no futuro pretendo aprender Java para desenvolver aplicações backend.
              </p>
            </div>
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="flex flex-col mt-8">
                  ...
                  <div className="flex gap-3 flex-wrap m-auto">
                    ...
                    <SkillButton text="Node"/>
                    <SkillButton text="Git"/>
                    <SkillButton text="Github"/>
                    <SkillButton text="Banco de dados SQL"/>
                  </div>
                </div>
              </div>
            </div>
